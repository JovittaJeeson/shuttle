...
class Player(models.Model):
    ...
    fixture = models.ForeignKey(Fixture, related_name="players", on_delete=models.CASCADE)  # Add on_delete argument here
...
class Match(models.Model):
    ...
    fixture = models.ForeignKey(Fixture, related_name="matches", on_delete=models.CASCADE)  # Add on_delete argument here
    match_round = models.IntegerField()
    left_previous = models.OneToOneField(
        'self', blank=True, null=True, related_name="left_next_match", on_delete=models.CASCADE)  # Add on_delete argument here
    right_previous = models.OneToOneField(
        'self', blank=True, null=True, related_name="right_next_match", on_delete=models.CASCADE)  # Add on_delete argument here

    player_1 = models.ForeignKey(
        Player, blank=True, null=True, related_name="left_matches", on_delete=models.CASCADE)  # Add on_delete argument here
    player_2 = models.ForeignKey(
        Player, blank=True, null=True, related_name="right_matches", on_delete=models.CASCADE)  # Add on_delete argument here
    ...
    winner = models.ForeignKey(
        Player, blank=True, null=True, related_name="matches_won", on_delete=models.CASCADE)  # Add on_delete argument here
    ...
    def get_result_values(self):
        return [self.player_1_score, self.player_2_score,]  # make sure to change the indentation of this line to match other lines
